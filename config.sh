...
CASITA_COMPOSER_IMAGE_NAME=$A6T_REG_HOST/a6t-casita-composer
CASITA_DECODER_IMAGE_NAME=$A6T_REG_HOST/a6t-casita-decoder

A6T_IMAGE_NAME_TAG=$A6T_IMAGE_NAME:$A6T_TAG
CASITA_COMPOSER_IMAGE_NAME_TAG=$CASITA_COMPOSER_IMAGE_NAME:$APP_VERSION
...
ALL_DOCKER_BUILD_IMAGES=( $A6T_IMAGE_NAME \
 $CASITA_COMPOSER_IMAGE_NAME $CASITA_DECODER_IMAGE_NAME )

ALL_DOCKER_BUILD_IMAGE_TAGS=( $A6T_IMAGE_NAME_TAG \
 $CASITA_COMPOSER_IMAGE_NAME_TAG $CASITA_DECODER_IMAGE_NAME_TAG )
